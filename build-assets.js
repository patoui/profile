...
async function buildCSS() {
  ...
  const command = isWatch
    ? 'npx tailwindcss -i ./assets/css/main.css -o ./public/dist/main.css --minify --watch'
    : 'npx tailwindcss -i ./assets/css/main.css -o ./public/dist/main.css --minify';
...
async function buildJS() {
  ...
  const ctx = await esbuild.context({
    entryPoints: ['./assets/js/highlight.js'],
    bundle: true,
    minify: true,
    sourcemap: true,
